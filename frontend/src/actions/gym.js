...
export const getExames = () => async dispatch => {
  const res = await axios.get(`/api/exames/${id}/`, tokenConfig(getState));
  dispatch({
    type: GET_EXAMES,
    payload: res.data
  });
...
export const getMatriculaPlanos = () => async dispatch => {
  const res = await axios.get(`/api/matricula_planos/${id}/`, tokenConfig(getState));
  dispatch({
...
export const getMatriculaTurmas = () => async dispatch => {
  const res = await axios.get(`/api/matricula_turmas/${id}/`, tokenConfig(getState));
  dispatch({
